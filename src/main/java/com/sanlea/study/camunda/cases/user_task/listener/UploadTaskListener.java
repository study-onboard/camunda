...
@ApplicationScoped
@Named("user_task_upload_task_listener")
public class UploadTaskListener implements TaskListener {
    ...
    public void notify(DelegateTask delegateTask) {
        ...
        logger.info(format("Uploading for form: {0} - {1}", formId, delegateTask.getId()));
        formManager.startUpload(formId, delegateTask.getId());
    }
}
